...
export default function Auth() {
    ...
    const signinHandler = async (e: React.FormEvent) => {
        ...
        try {
            ...
            devLogger.error("auth", "SignIn", "Something went wrong", error);
        }
    }
                ...
                <div className="p-8 flex flex-col gap-5">
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex justify-between items-center">
                            ...
                            <a className="text-xs hover:opacity-80 font-medium text-primary" href="#">Forgot password?</a>
                        </div>
                    ...
                    <button
                        ...
                        className="mt-2 flex w-full cursor-pointer items-center justify-center rounded-lg h-11 px-5 bg-primary hover:opacity-90 text-sm text-bg-app font-bold tracking-wide transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
                    ...
                    <div className="w-full">
                        <button className="flex items-center justify-center gap-2 rounded-lg border border-border dark:bg-bg-app hover:bg-opacity-70 h-10 px-4 w-full transition-colors">
